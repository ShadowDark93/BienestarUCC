...
@section('content')
    ...
    <div class="container p-3">
        <div class="row">
            <div class="col-sm-6">
                <div class="row mt-4">
                    <img src="{{ asset('img/bucc1.png') }}" class="img-fluid rounded float-none mx-auto d-block" alt="" align="center">
                </div>
                <br>
                <div class="row mt-4">
                    <img src="{{ asset('img/bucc2.png') }}" class="img-fluid rounded float-none mx-auto d-block" alt="image fluid" >
                </div>
            </div>
            <div class="col-sm-6">
                <div class="row mt-4">
                    <img src="{{ asset('img/b-ucc-logo.png') }}" class="img-fluid rounded float-none mx-auto d-block" alt="" align="center">
                </div>
                <br>
